...
import javax.swing.*;
class GuessNumberClient implements ActionListener {
    ...
    public GuessNumberClient(Socket s,PrintWriter write,BufferedReader reader) {
        /*this.s=s;
        this.write=write;
        this.reader= reader;*/
            ...
            @Override
                public void actionPerformed(ActionEvent ae){
                    try{
                        ...
                        System.out.println(flagr+"client");
                        if(flagr==0 && flag==0){
                           l3.setText("TIE");
